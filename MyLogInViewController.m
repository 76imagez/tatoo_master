...
- (void)viewDidLoad {
  ...
  // self.logInView.contentMode = UIViewContentModeScaleAspectFill;
    ...
    [self.logInView.passwordField setValue:[UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:1.0] forKeyPath:@"_placeholderLabel.textColor"];
    [self.logInView.usernameField setValue:[UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:1.0] forKeyPath:@"_placeholderLabel.textColor"];
}
...
- (void)viewDidLayoutSubviews {
    ...
    [self.logInView.passwordForgottenButton setFrame:CGRectMake(35.0f, 145.0f, 30.0f, 80.0f)];
